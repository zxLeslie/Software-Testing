...
public class AssertThatCompoundValueMatchers {
	...
	public void verify_multiple_values() throws Exception{
		...
		assertThat(marks,anyOf(equalTo(100.00),equalTo(1.00),equalTo(55.00),equalTo(55.00),equalTo(88.00),equalTo(67.8)));
		assertThat(marks,not(anyOf(equalTo(0.00),equalTo(200.00))));
		assertThat(marks,not(allOf(equalTo(100.00),equalTo(30.00))));
	}
}
